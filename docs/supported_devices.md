...
| -- | -- | -- | -- | -- | :--: | :-------------------------------------- | :------------------------------ | ----: | ------: | :----- |
|  | ✔️ | 🇷 | 🔋 | 🛜 | **TL** | `_TZ3000_dzwgk7e2` <br> `TS0042` | [Tuya TS0042 2-button remote (Custom)](https://www.zigbee2mqtt.io/devices/TS0042.html) |   |   | Custom pinout from user tracing: S1=C0, S3=B5, LED1=C2, LED3=A0 | 
